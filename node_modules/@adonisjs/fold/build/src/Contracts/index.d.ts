...
export interface IocContract<ContainerBindings extends any = any> {
     ...
     */
    call<T extends any, Method extends ExtractFunctions<T>>(target: T, method: Method, args?: any[]): ReturnType<T[Method]>;
    /**
     * Call a method on an object and automatically inject its depdencies
     */
    callAsync<T extends any, Method extends ExtractFunctions<T>>(target: T, method: Method, args?: any[]): Promise<UnWrapPromise<ReturnType<T[Method]>>>;
    /**
