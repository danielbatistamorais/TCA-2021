 ...
 */
exports.notIn = {
    compile: helpers_1.wrapCompile(RULE_NAME, ['string', 'number', 'array', 'date'], ([values], _, subtype) => {
        /**
         * Choices are defined as a ref
         */
        if (helpers_1.isRef(values)) {
            return {
    ...
    validate(value, compiledOptions, { errorReporter, pointer, arrayExpressionPointer, refs }) {
        ...
        if (compiledOptions.ref) {
            ...
            helpers_1.enforceArray(runtimevalues, `"${RULE_NAME}": expects "refs.${compiledOptions.ref}" to be an array`);
