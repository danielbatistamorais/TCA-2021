 ...
 */
exports.confirmed = {
    compile: helpers_1.wrapCompile(RULE_NAME, ['string', 'boolean', 'number', 'enum'], (args) => {
        const res = {
            compiledOptions: {
    ...
    validate(value, { confirmationFieldName }, { errorReporter, field, pointer, arrayExpressionPointer, root, tip }) {
        ...
        if (helpers_1.getFieldValue(confirmationFieldName, root, tip) != value) {
            errorReporter.report(helpers_1.resolveAbsoluteName(confirmationFieldName, pointer), RULE_NAME, DEFAULT_MESSAGE, arrayExpressionPointer);
        }
    },
};
