 ...
 */
exports.beforeField = {
    compile: helpers_1.wrapCompile(RULE_NAME, [], (options, _, __, rulesTree) => {
        return field_1.compile(RULE_NAME, '<', options, rulesTree);
    }),
    validate(value, compiledOptions, runtimeOptions) {
        return field_1.validate(RULE_NAME, DEFAULT_MESSAGE, value, compiledOptions, runtimeOptions);
    },
};
