 ...
 */
exports.after = {
    compile: helpers_1.wrapCompile(RULE_NAME, ['date'], (options) => {
        return offset_1.compile(RULE_NAME, '>', options);
    }),
    validate(value, compiledOptions, runtimeOptions) {
        return offset_1.validate(RULE_NAME, DEFAULT_MESSAGE, value, compiledOptions, runtimeOptions);
    },
};
