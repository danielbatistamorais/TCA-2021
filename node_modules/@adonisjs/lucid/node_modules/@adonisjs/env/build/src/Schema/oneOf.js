...
function oneOf(choices, options) {
    return function validate(key, value) {
        helpers_1.ensureValue(key, value, options === null || options === void 0 ? void 0 : options.message);
        return ensureOneOf(choices, key, value, options === null || options === void 0 ? void 0 : options.message);
    };
}
exports.oneOf = oneOf;
/**
