...
class Registrar {
     ...
     * automatically.
     */
    loadProvider(providerPath, basePath) {
        providerPath = this.basePath
            ? utils_1.resolveFrom(basePath || this.basePath, providerPath)
            : providerPath;
        ...
        return {
            ...
            resolvedPath: path_1.dirname(providerPath),
        };
    }
    /**
     ...
     */
    collect(providerPaths, basePath) {
