...
class MarkdownRenderer {
    ...
    async renderInBrowser() {
        try {
            const contents = await fs_extra_1.readFile(this.mdFileAbsPath, 'utf-8');
            const html = this.generateHtml(marked_1.default.setOptions({ renderer: new marked_1.default.Renderer() })(contents.trim()));
    ...
    async renderInTerminal() {
        try {
            const contents = await fs_extra_1.readFile(this.mdFileAbsPath, 'utf-8');
            console.log(marked_1.default.setOptions({ renderer: new marked_terminal_1.default() })(contents.trim()).trim());
        }
        catch (error) { }
    }
}
