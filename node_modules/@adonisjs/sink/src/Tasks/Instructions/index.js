...
class Instructions {
    ...
    getPackagePath() {
        try {
            return helpers_1.resolveFrom(this.projectRoot, `${this.packageName}/package.json`);
        }
        catch (error) {
    ...
    async runInstructions(instructions) {
         ...
         */
        const instructionsPath = helpers_1.resolveFrom(path_1.dirname(this.packagePath), instructions.instructions);
        /**
