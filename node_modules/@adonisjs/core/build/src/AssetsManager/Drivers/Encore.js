...
class EncoreDriver {
    ...
    manifest() {
        ...
        const manifest = this.readFileAsJSON(path_1.join(this.publicPath, 'manifest.json'));
    ...
    entryPoints() {
        ...
        const entryPoints = this.readFileAsJSON(path_1.join(this.publicPath, 'entrypoints.json'));
